...
-- Chèn dữ liệu vào bảng VACCINE (không có NgaySX và HanSuDung)
INSERT INTO VACCINE(MaVC, MaLoai, TenVC, Gia, XuatXu) VALUES
('VC001', 'LV001', N'Engerix-B', 180000, N'Bỉ'),
('VC002', 'LV001', N'Hepavax-Gene', 120000, N'Hàn Quốc'),
('VC003', 'LV002', N'Infanrix-IPV', 150000, N'Mỹ'),
('VC004', 'LV002', N'Pentaxim', 80000, N'Pháp'),
('VC005', 'LV002', N'Adacel', 200000, N'Mỹ'),
('VC006', 'LV003', N'M-M-R II', 160000, N'Mỹ'),
('VC007', 'LV003', N'Priorix', 130000, N'Bỉ'),
('VC008', 'LV004', N'JE-VAX', 100000, N'Nhật Bản'),
('VC009', 'LV004', N'Ixiaro', 90000, N'Áo'),
('VC010', 'LV004', N'Encepur', 180000, N'Đức'),
('VC011', 'LV005', N'Rotarix', 220000, N'Bỉ'),
('VC012', 'LV005', N'RotaTeq', 170000, N'Mỹ'),
('VC013', 'LV006', N'Varilrix', 190000, N'Bỉ'),
('VC014', 'LV006', N'Varivax', 250000, N'Mỹ'),
('VC015', 'LV007', N'Prevenar 13', 280000, N'Mỹ'),
('VC016', 'LV007', N'Synflorix', 230000, N'Bỉ'),
('VC017', 'LV008', N'Influvac', 160000, N'Hà Lan'),
('VC018', 'LV008', N'Vaxigrip', 180000, N'Pháp'),
('VC019', 'LV009', N'Gardasil', 260000, N'Mỹ'),
('VC020', 'LV009', N'Cervarix', 270000, N'Bỉ'),
('VC021', 'LV010', N'Verorab', 240000, N'Pháp'),
('VC022', 'LV010', N'Rabipur', 170000, N'Đức'),
('VC023', 'LV001', N'Euvax-B', 190000, N'Hàn Quốc'),
('VC024', 'LV002', N'Boostrix', 270000, N'Bỉ'),
('VC025', 'LV007', N'Pneumovax 23', 290000, N'Mỹ'),
('VC026', 'LV001', N'Heberbiovac-HB', 165000, N'Cuba'),
('VC027', 'LV001', N'Shanvac-B', 155000, N'Ấn Độ'),
('VC028', 'LV001', N'Bio-Hep-B', 175000, N'Hàn Quốc'),
('VC029', 'LV002', N'Tripacel', 320000, N'Canada'),
('VC030', 'LV002', N'Daptacel', 310000, N'Mỹ'),
('VC031', 'LV002', N'Infanrix Hexa', 450000, N'Bỉ'),
('VC032', 'LV003', N'Trimovax', 280000, N'Pháp'),
('VC033', 'LV003', N'MeaslesRub', 260000, N'Ấn Độ'),
('VC034', 'LV003', N'MMR-II Japan', 290000, N'Nhật Bản'),
('VC035', 'LV004', N'Biken JE', 420000, N'Nhật Bản'),
('VC036', 'LV004', N'IMOJEV', 400000, N'Thái Lan'),
('VC037', 'LV004', N'CD.JEVAX', 380000, N'Trung Quốc'),
('VC038', 'LV005', N'Rotasiil', 350000, N'Ấn Độ'),
('VC039', 'LV005', N'Rotavac', 340000, N'Ấn Độ'),
('VC040', 'LV006', N'Okavax', 420000, N'Nhật Bản'),
('VC041', 'LV006', N'Vari-L', 400000, N'Hàn Quốc'),
('VC042', 'LV007', N'Pneumococcal PS', 520000, N'Hàn Quốc'),
('VC043', 'LV007', N'PCV13', 550000, N'Mỹ'),
('VC044', 'LV008', N'FluQuadri', 320000, N'Pháp'),
('VC045', 'LV008', N'Fluarix Tetra', 340000, N'Bỉ'),
('VC046', 'LV008', N'Inflexal V', 330000, N'Thụy Sĩ'),
('VC047', 'LV009', N'Gardasil 9', 850000, N'Mỹ'),
('VC048', 'LV009', N'Cecolin', 750000, N'Trung Quốc'),
('VC049', 'LV010', N'Abhayrab', 280000, N'Ấn Độ'),
('VC050', 'LV010', N'Speeda', 300000, N'Thái Lan'),
('VC051', 'LV011', N'Havrix', 450000, N'Bỉ'),
('VC052', 'LV011', N'Avaxim', 420000, N'Pháp'),
('VC053', 'LV011', N'Epaxal', 440000, N'Thụy Sĩ'),
('VC054', 'LV012', N'Pneumoforce', 380000, N'Ấn Độ'),
('VC055', 'LV012', N'Prevnar20', 620000, N'Mỹ'),
('VC056', 'LV012', N'Pneumosil', 400000, N'Ấn Độ'),
('VC057', 'LV013', N'Typhim Vi', 320000, N'Pháp'),
('VC058', 'LV013', N'Typbar', 300000, N'Ấn Độ'),
('VC059', 'LV013', N'Typherix', 310000, N'Bỉ'),
('VC060', 'LV014', N'Menactra', 850000, N'Mỹ'),
('VC061', 'LV014', N'Nimenrix', 820000, N'Bỉ'),
('VC062', 'LV014', N'MenQuadfi', 840000, N'Pháp'),
('VC063', 'LV015', N'Pfizer-BioNTech', 520000, N'Mỹ/Đức'),
('VC064', 'LV015', N'Moderna', 540000, N'Mỹ'),
('VC065', 'LV015', N'AstraZeneca', 480000, N'Anh/Thụy Điển'),
('VC066','LV001',N'GenHevac B',185000,N'Pháp'),
('VC067','LV001',N'Regevac B',175000,N'Cuba'),
('VC068','LV001', N'Hepavax-Gene Pro',195000,N'Hàn Quốc'),
('VC069','LV001',N'Euvax B Pediatric',180000,N'Hàn Quốc'),
('VC070','LV001',N'Bio-Hep-B Plus',190000, N'Ấn Độ'),
('VC071', 'LV002', N'Pentacel', 460000, N'Canada'),
('VC072', 'LV002', N'Quadracel', 440000, N'Mỹ'),
('VC073', 'LV002', N'Hexaxim', 480000, N'Pháp'),
('VC074', 'LV002', N'Hexyon', 470000, N'Pháp'),
('VC075', 'LV002', N'Vaxelis', 490000, N'Mỹ'),
('VC076', 'LV003', N'MMR-RIT', 270000, N'Bỉ'),
('VC077', 'LV003', N'Priorix Tetra', 290000, N'Bỉ'),
('VC078', 'LV003', N'ProQuad', 285000, N'Mỹ'),
('VC079', 'LV003', N'Trimovax Merieux', 275000, N'Pháp'),
('VC080', 'LV003', N'MeaslesMumps', 265000, N'Ấn Độ'),
('VC081', 'LV004', N'JEBIK V', 410000, N'Nhật Bản'),
('VC082', 'LV004', N'Japanese E', 390000, N'Hàn Quốc'),
('VC083', 'LV004', N'JE-ADVAX', 430000, N'Australia'),
('VC084', 'LV004', N'JEVAC', 400000, N'Việt Nam'),
('VC085', 'LV004', N'JEEV', 420000, N'Ấn Độ'),
('VC086', 'LV005', N'Rotavac 5D', 360000, N'Ấn Độ'),
('VC087', 'LV005', N'Rotavin-M1', 340000, N'Việt Nam'),
('VC088', 'LV005', N'RotaShield', 370000, N'Mỹ'),
('VC089', 'LV005', N'Rotarix Oral', 350000, N'Bỉ'),
('VC090', 'LV005', N'RotaTeq Oral', 365000, N'Mỹ'),
('VC091', 'LV006', N'Varicella-K', 410000, N'Hàn Quốc'),
('VC092', 'LV006', N'V-ZOS', 430000, N'Nhật Bản'),
('VC093', 'LV006', N'VarZos', 420000, N'Ấn Độ'),
('VC094', 'LV006', N'Variped', 440000, N'Pháp'),
('VC095', 'LV006', N'Varcivax', 425000, N'Bỉ'),
('VC096', 'LV007', N'Pneumo 23', 540000, N'Pháp'),
('VC097', 'LV007', N'PneumoMax', 530000, N'Ấn Độ'),
('VC098', 'LV007', N'Prevenar 15', 560000, N'Mỹ'),
('VC099', 'LV007', N'Pneumovax Plus', 550000, N'Mỹ'),
('VC100', 'LV007', N'PneumoSafe', 545000, N'Hàn Quốc'),
('VC101', 'LV008', N'FluMist', 350000, N'Mỹ'),
('VC102', 'LV008', N'Flucelvax', 345000, N'Thụy Sĩ'),
('VC103', 'LV008', N'Afluria', 335000, N'Australia'),
('VC104', 'LV008', N'FluLaval', 340000, N'Canada'),
('VC105', 'LV008', N'Fluzone HD', 360000, N'Mỹ'),
('VC106', 'LV009', N'HPV-16', 800000, N'Trung Quốc'),
('VC107', 'LV009', N'Gardasil Plus', 880000, N'Mỹ'),
('VC108', 'LV009', N'Cervarix Pro', 820000, N'Bỉ'),
('VC109', 'LV009', N'HPV-Prevent', 840000, N'Ấn Độ'),
('VC110', 'LV009', N'VacciHPV', 860000, N'Hàn Quốc'),
('VC111', 'LV010', N'RabAvert', 290000, N'Đức'),
('VC112', 'LV010', N'RabiShield', 285000, N'Ấn Độ'),
('VC113', 'LV010', N'RabiGen', 295000, N'Thụy Sĩ'),
('VC114', 'LV010', N'RabiVax', 280000, N'Việt Nam'),
('VC115', 'LV010', N'RabiPur Plus', 310000, N'Đức'),
('VC116', 'LV011', N'Healive', 430000, N'Trung Quốc'),
('VC117', 'LV011', N'Avaxim Pediatric', 445000, N'Pháp'),
('VC118', 'LV011', N'Havrix Junior', 460000, N'Bỉ'),
('VC119', 'LV011', N'Vaqta', 450000, N'Mỹ'),
('VC120', 'LV011', N'HepA-Vax', 440000, N'Hàn Quốc');
